...
git checkout dev
git merge master
git add models.py routes.py run.py templates/share.html templates/share_detail.html templates/share_map.html templates/share_report.html templates/share_report_edit.html
git commit -m "공유마당 다중사진 업로드 + 수정/삭제 기능"
git push origin dev
2. master에 병합 → 푸시
...
3. SSH → prod 적용
ssh -i C:\Users\i0wil\.ssh\LightsailDefaultKey-ap-northeast-2.pem ubuntu@3.38.34.11
cd ~/yp_project
git pull origin master
sudo supervisorctl restart yp_app

git checkout dev
git add templates/register.html
git commit -m "회원가입 최대한 편안하게 하기"
git push origin dev

ssh -i C:\Users\i0wil\.ssh\LightsailDefaultKey-ap-northeast-2.pem ubuntu@3.38.34.11
cd ~/yp_project_dev 
git pull origin dev 
sudo supervisorctl restart yp_dev
...
ssh -i C:\Users\i0wil\.ssh\LightsailDefaultKey-ap-northeast-2.pem ubuntu@3.38.34.11
cd ~/yp_project && git pull origin master && sudo supervisorctl restart yp_app